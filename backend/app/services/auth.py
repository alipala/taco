...
from app.database import users_collection, sessions_collection, password_reset_collection
from app.schemas.auth import UserInDB, TokenData, UserResponse, UserCreate, PasswordReset
...
async def reset_password(token: str, new_password: str) -> bool:
    ...
    if not created_at or (datetime.utcnow() - created_at).total_seconds() > 3600:
